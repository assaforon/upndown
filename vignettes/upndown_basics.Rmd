...
```{r elfawal1, echo = -1, fig.width = 12, fig.height = 7, out.width=1300, out.height=700}
par(mfrow=1:2, mar=c(4,4,4,1))
...
udplot(x=elfawal_short_x, y=elfawal_short_y, main = "El Fawal et al. 2021, Shorter Axial Length", 
       ytitle = "Anesthetic volume (ml)", las = 1)
...
udplot(x=elfawal_long_x, y=elfawal_long_y, main = "El Fawal et al. 2021, Longer Axial Length", 
       ytitle = "Anesthetic volume (ml)", las = 1)
...
```{r elfawal2, echo = -1, fig.width = 12, fig.height = 7, out.width=1300, out.height=700}
par(mfrow=1:2, mar=c(4,4,4,1))

drplot(x=elfawal_short_x, y=elfawal_short_y, main = "El Fawal et al. 2021, Shorter Axial Length", 
       xtitle = "Anesthetic volume (ml)", percents = TRUE, las = 1,
       addest = TRUE, target = 0.9, addcurve = TRUE)

drplot(x=elfawal_long_x, y=elfawal_long_y, main = "El Fawal et al. 2021, Longer Axial Length", 
       xtitle = "Anesthetic volume (ml)", percents = TRUE, las = 1,
       addest = TRUE, target = 0.9, addcurve = TRUE)

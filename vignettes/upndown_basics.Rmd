...
**We generally recommend using CIR for estimating the target dose and the confidence interval.** It is more robust than dose-averaging estimators, and likewise its CI coverage is more consistent. See, e.g., [the supplement to Oron et al. 2022.](https://links.lww.com/ALN/C867) 

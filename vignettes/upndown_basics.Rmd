...
Gorla et al. used the original Dixon-Mood estimator, a weighted average of the sequence of 13 doses which yielded 40.91 kN. `upndown` does include an implementation of this estimate:


```{r dm1}
dixonmood(gorla751x, gorla751y)
```

The result is slightly different from Gorla et al.'s value, because there are a myriad slight variations on how Dixon-Mood *(often called Dixon-Massey)* is applied. We consider it an obsolete estimator, and provide it mostly for comparisons such as this.

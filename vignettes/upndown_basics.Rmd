...
```
 ...
 - This run had $n=13,$ which for live-subject experiments is probably on the low side. Given these gears are industrial products which likely undergo tight process control, this $n$ might suffice.
...
Estimating the target becomes as simple as reading off the dose-response plot, and seeing where the CIR curve crosses $y=target.$
